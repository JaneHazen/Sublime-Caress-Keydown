...
var _rtfeldman$elm_workshop$Main$initialModel = {
	...
	results: {
		...
		_1: {
			ctor: '::',
			_0: {id: 2, name: 'grzegorzbalcerek/elm-by-example', stars: 41},
			_1: {
				ctor: '::',
				_0: {id: 3, name: 'sporto/elm-tutorial-app', stars: 35},
				_1: {
					ctor: '::',
					_0: {id: 4, name: 'jvoigtlaender/Elm-Tutorium', stars: 10},
					_1: {
						ctor: '::',
						_0: {id: 5, name: 'sporto/elm-tutorial-assets', stars: 7},
						_1: {ctor: '[]'}
					}
				}
			}
